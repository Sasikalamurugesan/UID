      ...
      <div style={cardStyle}>
        <div className="col-md-12">
          ...
          <form onSubmit={handleLogin} className="login">
            ...
            {/* Conditional rendering for Remember Me checkbox */}
            {/*
              Render the checkbox only if a certain condition is met.
              For example, render it only if username is not empty.
            */}
            {username !== '' && (
              <div className="mb-3">
                <label>
            ...
            <br/><h1 className="text-center">(or)</h1>
            <button style={{backgroundColor:'white',color:'black',alignItems:''}}onClick={() => loginWithRedirect()} >
                <img src="https://tse3.mm.bing.net/th?id=OIP.yL98CHypeT0JQEKEVwf_rAHaHa&pid=Api&P=0&h=180" alt="Google Logo" style={{ marginRight: '10px',paddingLeft:'80px',width:'200px',alignItems:'center',justifyContent:'center',display:'flex' }} />
                </button><br/>
